...
function employeeByDepartments() {
  ...
  /*connection.query(departmentQuery1, (err, response) => {*/
    ...
    inquirer.prompt([{
      ...
      WHERE ?`
      /*connection.query(departmentQuery2, [{ name: answer.dept }], function (err, res) {*/
...
function removeRole() {
  /*let query1 = `SELECT * FROM emprole`*/
  ...
  connection.query(queryRemoveRole, (err, res) => {
    ...
    inquirer.prompt([{
      ...
      .then(answer => {
        ...
        let queryDeleteRole = `DELETE FROM role WHERE ?`
  ...
  connection.query(query, (err, response) => {
    ...
    /*.then(input1 => {*/
      .then(updateEmployee=> {
        ...
        WHERE employee.id = ?`
              /*connection.query(query1, [input2.roleId, updatEmployee.employeeId], function (err, res) {*/
                ...
                /*for (var k = 0; k < roles.length; k++) {*/
                  ...
                  /*if (roles[k].value == input2.roleId) {*/
                    if (roles[i].value == update.roleId) {
                ...
                var tempName;
                for (var i = 0; i < employees.length; g++) {
                  /*if (employees[g].value == input1.employeeId) {*/
                  if (employees[g].value == updateEmployee.employeeId) {
  ...
  connection.query(queryAddRole, (err, data) => {
    ...
    inquirer.prompt([
      ...
      .then(function (answers) {
        /*let query2 = `INSERT INTO emprole VALUES (?,?,?,?)`*/
